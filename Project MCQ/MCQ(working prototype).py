...
def waiting(): # to show the frames
    fir.destroy()
    messagebox.showinfo(title="Exam Instructions",message="1. Choose the option button to select your Answer \n2. Click the save button to lock Your answer \n3.Click on the Next or Previous buttons to navigate between questions \n4.The Question Number Panel can also be used to go to the question of that number\n5.After finishing the exam Press submit to finalize your answers")
...
lbl1=Label(frame1,bg="white",font=("Arial bold",15)) #question number label
lbl1.grid(row=0,column=0)
lbl2=Label(frame1,bg="white",font=("Arial",12)) #Question information Label
lbl2.place(x=60,y=50)

selected=IntVar()
selects=list()

ans1=Label(frame1,bg="white",font=("Arial",12))
ans2=Label(frame1,bg="white",font=("Arial",12))
ans3=Label(frame1,bg="white",font=("Arial",12))
ans4=Label(frame1,bg="white",font=("Arial",12))
rad0=Radiobutton(frame1,bg="white",value=0,variable=selected)
rad1=Radiobutton(frame1,bg="white",value=1,variable=selected)
rad2=Radiobutton(frame1,bg="white",value=2,variable=selected)
rad3=Radiobutton(frame1,bg="white",value=3,variable=selected)
rad4=Radiobutton(frame1,bg="white",value=4,variable=selected)
